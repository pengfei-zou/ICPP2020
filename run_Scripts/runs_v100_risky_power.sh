...
#PBS -o /scratch3/pzou/powerv100.risky.o
#PBS -e /scratch3/pzou/powerv100.risky.e
...
mkdir ${scratch_results}/risky/v100/power-${nodeName}-${current_date_time}
mkdir ${home_results}/risky/v100/power-${nodeName}-${current_date_time}
...
while ps -p $pid >/dev/null 2>&1; do
	sleep 600
    rm $TMPDIR/CUPTI*
	rsync -az $TMPDIR/ ${scratch_results}/risky/v100/power-${nodeName}-${current_date_time}
    rsync -az $TMPDIR/ ${home_results}/risky/v100/power-${nodeName}-${current_date_time}
