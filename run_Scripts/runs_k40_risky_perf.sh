...
#PBS -o /scratch3/pzou/perfk40.risky.o
#PBS -e /scratch3/pzou/perfk40.risky.e
...
mkdir ${scratch_results}/risky/k40/perf-temp
mkdir ${home_results}/risky/k40/perf-temp
...
#python ./perf.py ./metrics.csv ./applications_risky_re.csv &
#pid2=$!

while ps -p $pid >/dev/null 2>&1; do
	sleep 600
    rm $TMPDIR/CUPTI*
	rsync -az $TMPDIR/ ${scratch_results}/risky/k40/perf-temp
    rsync -az $TMPDIR/ ${home_results}/risky/k40/perf-temp
...
#done
rm $TMPDIR/CUPTI*
rsync -az $TMPDIR/ ${scratch_results}/risky/k40/perf-${nodeName}-${current_date_time}
rsync -az $TMPDIR/ ${home_results}/risky/k40/perf-${nodeName}-${current_date_time}
