#!/bin/sh
#PBS -N risky_v100
#PBS -l select=1:ncpus=40:mem=60gb:ngpus=1:gpu_model=v100,walltime=72:00:00
#PBS -o /scratch3/pzou/mem_tracev100.risky.o
#PBS -e /scratch3/pzou/mem_tracev100.risky.e
...
mkdir ${scratch_results}/risky/v100/mem_trace-${nodeName}-${current_date_time}
mkdir ${home_results}/risky/v100/mem_trace-${nodeName}-${current_date_time}


python ./mem_trace.py ./V100_memtrace_rerun_risky.csv &
pid=$!
...
while ps -p $pid >/dev/null 2>&1; do
	sleep 600
    rm $TMPDIR/CUPTI*
	rsync -az $TMPDIR/ ${scratch_results}/risky/v100/mem_trace-${nodeName}-${current_date_time}
    rsync -az $TMPDIR/ ${home_results}/risky/v100/mem_trace-${nodeName}-${current_date_time}
