...
export BENCHDIR="/home/pzou/projects/Power_Signature/DeepBench/dlbs/python/tf_cnn_benchmarks"
export BENCHTYPE="AI"
...
cd /home/pzou/projects/Power_Signature/Scripts
...
python ./mem_trace_AI.py applications_AI.csv &
pid=$!
