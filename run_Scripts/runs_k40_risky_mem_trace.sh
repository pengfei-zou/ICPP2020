...
#PBS -o /scratch3/pzou/mem_tracek40.risky.o
#PBS -e /scratch3/pzou/mem_tracek40.risky.e
...
mkdir ${scratch_results}/risky/k40/${nodeName}-${current_date_time}
mkdir ${home_results}/risky/k40/${nodeName}-${current_date_time}


python ./mem_trace.py K40_memtrace_rerun_risky.csv &
...
while ps -p $pid >/dev/null 2>&1; do
	sleep 600
    rm $TMPDIR/CUPTI*
	rsync -az $TMPDIR/ ${scratch_results}/risky/k40/${nodeName}-${current_date_time}
    rsync -az $TMPDIR/ ${home_results}/risky/k40/${nodeName}-${current_date_time}
