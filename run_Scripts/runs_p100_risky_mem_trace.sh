...
#PBS -o /scratch3/pzou/mem_tracep100.risky.o
#PBS -e /scratch3/pzou/mem_tracep100.risky.e
...
mkdir ${scratch_results}/risky/p100/mem_trace-${nodeName}-${current_date_time}
mkdir ${home_results}/risky/p100/mem_trace-${nodeName}-${current_date_time}


python ./mem_trace.py ./applications_risky_re.csv &
pid=$!
...
while ps -p $pid >/dev/null 2>&1; do
	sleep 600
    rm $TMPDIR/CUPTI*
	rsync -az $TMPDIR/ ${scratch_results}/risky/p100/mem_trace-${nodeName}-${current_date_time}
    rsync -az $TMPDIR/ ${home_results}/risky/p100/mem_trace-${nodeName}-${current_date_time}
