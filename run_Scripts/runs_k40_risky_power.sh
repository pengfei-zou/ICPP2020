...
#PBS -o /scratch3/pzou/powerk40.risky.o
#PBS -e /scratch3/pzou/powerk40.risky.e
...
mkdir ${scratch_results}/risky/k40/power-${nodeName}-${current_date_time}
mkdir ${home_results}/risky/k40/power-${nodeName}-${current_date_time}


python ./power.py ./applications_risky_re.csv &
...
while ps -p $pid >/dev/null 2>&1; do
	sleep 600
    rm $TMPDIR/CUPTI*
	rsync -az $TMPDIR/ ${scratch_results}/risky/k40/power-${nodeName}-${current_date_time}
    rsync -az $TMPDIR/ ${home_results}/risky/k40/power-${nodeName}-${current_date_time}
