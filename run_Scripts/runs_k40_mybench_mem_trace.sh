#!/bin/sh
#PBS -N mybench_k40
#PBS -l select=1:ncpus=24:mem=60gb:ngpus=1:gpu_model=k40,walltime=72:00:00
#PBS -o /scratch3/pzou/mem_tracek40.mybench.o
#PBS -e /scratch3/pzou/mem_tracek40.mybench.e
...
mkdir ${scratch_results}/mybench/k40/mem_trace-${nodeName}-${current_date_time}
mkdir ${home_results}/mybench/k40/mem_trace-${nodeName}-${current_date_time}


python ./mem_trace.py K40_memtrace_rerun.csv &
...
while ps -p $pid >/dev/null 2>&1; do
	sleep 600
    rm $TMPDIR/CUPTI*
	rsync -az $TMPDIR/ ${scratch_results}/mybench/k40/mem_trace-${nodeName}-${current_date_time}
    rsync -az $TMPDIR/ ${home_results}/mybench/k40/mem_trace-${nodeName}-${current_date_time}
