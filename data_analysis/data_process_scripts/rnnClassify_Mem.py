...
def rnnClassify(data_kernel_group, data_transfer_group, y_label,  arch, model_eval, ratio):
    ...
    for index_label in range(1, 6):
        ...
        y_prob = model.predict([data_kernel_group, data_transfer_group])
        ...
        y_prob = model.predict([X_kernel_test, X_transfer_test])
        y_predict = [int(i>=0.5) for i in y_prob]
...
if __name__=="__main__":
    ...
    rnnClassify(data_kernel_group, data_transfer_group, y_label,  arch, model_eval, ratio)
