...
def rnnClassify50(data_group, y_label,  arch, model_eval, ratio):
    y_label = pd.Series(y_label)
...
def rnnClassify10(data_group, y_label,  arch, model_eval, ratio):
    y_label = pd.Series(y_label)
...
if __name__=="__main__":
    ...
    #for model_eval in ["unseen"]:
    #    for ratio in [3, 4, 5, 6, 7, 8, 9, 10, 12, 15, 18, 20]:

    if sample_rate == 100:
        rnnClassify100(data_group, y_label,  arch, model_eval, ratio)
    elif sample_rate == 50:
        rnnClassify50(data_group, y_label,  arch, model_eval, ratio)
    elif sample_rate == 10:
        rnnClassify10(data_group, y_label,  arch, model_eval, ratio)
