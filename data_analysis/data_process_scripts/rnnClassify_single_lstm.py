...
def rnnClassify(data_group,  y_label,  arch, model_eval, ratio):
    ...
    for index_label in range(1, 6):
        ...
        y_prob = model.predict(data_group)
...
if __name__=="__main__":
    ...
    rnnClassify(data_group, y_label,  arch, model_eval, ratio)
