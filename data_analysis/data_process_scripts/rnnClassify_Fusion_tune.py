...
def rnnClassify(data_kernel_group, data_transfer_group, data_res_group, y_label,  arch, model_eval, index_label):
    ...
    z = (layers.LSTM(512, input_shape=(max_res_len, 4)))(inputRes)
...
if __name__=="__main__":
    ...
    index_label = int(sys.argv[3])
    rnnClassify(data_kernel_group, data_transfer_group, data_res_group, y_label,  arch, model_eval, index_label)
